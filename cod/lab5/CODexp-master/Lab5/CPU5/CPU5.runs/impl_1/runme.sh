...
HD_PWD='C:/CODexp/Lab5/CPU5/CPU5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Run_ol.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Run_ol.tcl -notrace
