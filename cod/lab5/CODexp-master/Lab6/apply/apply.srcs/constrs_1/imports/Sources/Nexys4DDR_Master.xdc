...
# set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { finish }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
# set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { order[0] }]; #IO_L4N_T0_D05_14 Sch=btnu
# set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { order[1] }]; #IO_L12P_T1_MRCC_14 Sch=btnl
