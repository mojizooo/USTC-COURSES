...
\synth_options.dist_mem_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dist_mem_gen_v8_0_13_synth
     port map (
      ...
      spo(13) => \^spo\(25),
      spo(12) => \^spo\(15),
      spo(11 downto 6) => \^spo\(21 downto 16),
      spo(5 downto 0) => \^spo\(5 downto 0)
    );
end STRUCTURE;
library IEEE;
