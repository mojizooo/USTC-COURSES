...
HD_PWD='C:/Users/Asus/Documents/GitHub/COD_labs/_lab3/src/_lab3/_lab3.runs/ins_a_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ins_a.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ins_a.tcl
