...
HD_PWD='C:/Users/Asus/Documents/GitHub/COD_labs/_lab3/src/_lab3/_lab3.runs/num_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log num.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source num.tcl
