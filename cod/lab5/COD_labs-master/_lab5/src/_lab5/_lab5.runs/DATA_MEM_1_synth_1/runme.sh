...
HD_PWD='C:/Users/Asus/Documents/GitHub/COD_labs/_lab5/src/_lab5/_lab5.runs/DATA_MEM_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DATA_MEM_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DATA_MEM_1.tcl
