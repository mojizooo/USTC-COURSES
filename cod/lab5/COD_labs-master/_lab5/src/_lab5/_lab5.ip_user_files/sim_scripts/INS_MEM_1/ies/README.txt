...
#
# Generated by export_simulation on Thu Jun 18 19:11:35 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './INS_MEM_1.sh' script.

./INS_MEM_1.sh -reset_run
...
./INS_MEM_1.sh -noclean_files

For more information on the script, please type './INS_MEM_1.sh -help'.
