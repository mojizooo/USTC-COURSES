...
#
# Generated by export_simulation on Thu Jun 18 19:36:18 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './DATA_MEM_1.sh' script.

./DATA_MEM_1.sh -reset_run
...
./DATA_MEM_1.sh -noclean_files

For more information on the script, please type './DATA_MEM_1.sh -help'.
